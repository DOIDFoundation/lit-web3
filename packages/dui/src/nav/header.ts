...
export class DuiHeader extends TailwindElement(style) {
  ...
  render() {
    return html`
      ${when(this.fixed, () => html`<div class="dui-header-placeholder"></div>`)}
      <header class="dui-header ${classMap({ fixed: this.fixed })}">
        <div class="dui-container relative flex justify-between items-center ${classMap({ full: this.full })}">
          ...
          <div class="flex justify-end items-center gap-2 lg_w-40">
