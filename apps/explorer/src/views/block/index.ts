import { ThemeElement, html, customElement, state, when, property } from '@lit-web3/dui/shared/theme-element'
          ...
          ${when(
            ...
            () => html`
              ${when(
                ...
                `,
                () => html` <div class="font-bold text-xl text-red-600">Unknown</div> `
              )}
            `
          )}
        </div>
