  ...
  render() {
    return html`<div class="dapp-landing">
      <div class="dui-container">
        ...
        <dui-button class="outlined w-full my-2" @click=${() => goto('/create')}
          >Generate main address for all chains for me</dui-button
        >
        ${when(
          this.ownerAddress && !this.mainAddress,
          () => html`<dui-button class="outlined w-full my-2" @click=${() => goto('/recover')}
        ...
        <dui-button class="outlined w-full my-2" @click=${() => goto(`/restore/${this.wrapName}`)}
