...
import setupAllControllers from '~/lib.legacy/controllers'
import setupAllMethods from '~/lib.legacy/keyringController.setup/methods'
...
import setupAllMiddlewares from '~/lib.legacy/middlewares'
...
import OnboardingController from '~/lib.legacy/controllers/onBoarding'
import setupPump from '~/lib.legacy/keyringController.setup/setupPump'
